...
if($_POST){
    ...
    $indexid = 0;
    $query = "Select r.id, r.title, r.imageurl, r.typeid, t.title as type From recipematerial as rm Left Join recipe as r On rm.recipeid=r.id Left Join type as t On r.typeid = t.id Where";
